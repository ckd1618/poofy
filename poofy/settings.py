"""
Django settings for poofy project.
...
SECRET_KEY = '^i%1na$j9ud7vfk__!$=ri@e$gkxiukagt5%@75$bdo*95i^a_'
...
WSGI_APPLICATION = 'poofy.wsgi.application'
...
EMAIL_HOST_PASSWORD = 'cchrissdd'#enter your password here as you setup the server